...
func (s *MenuService) Create(ctx context.Context, item *models.MenuItems) error {
	...
	log.Println("Menu item created successfully:", item.MenuItemId)
	return nil
}
